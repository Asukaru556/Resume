  ...
  <section class="hero-section">
    ...
    <div class="hero-right">
      ...
      <div class="description">
        <p>Меня зовут Аскар, я студент 4 курса направления frontend-разработчик. Специализируюсь на создании пользовательских интерфейсов на Vue 3, React. В работе использую JavaScript/TypeScript, Pinia, Vue Router, Vite, REST API и Git.</p>
